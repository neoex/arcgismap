...
public class GaodeImageTiledLayer extends ServiceImageTiledLayer {
    ...
    private int mCurrentType = IMAGE;
    ...
    public static GaodeImageTiledLayer getInstance() {
        return new GaodeImageTiledLayer(getCommonTileInfo(), new Envelope(-2.2041257773878E7D, -3.26739396727517E7D, 2.2041257773878E7D, 2.08513500432886E7D, SpatialReferences.getWebMercator()));
    }
